...
class Space {
  static Widget? x(double no) => SizedBox(width: AppDimensions.normalize(no));
  static Widget? y(double no) => SizedBox(height: AppDimensions.normalize(no));
  static Widget? x1;
  static Widget? y1;
  static Widget? x2;
  static Widget? y2;
  ...
  static void init() {
    x1 = SizedBox(width: AppDimensions.space(0.5));
    y1 = SizedBox(height: AppDimensions.space(0.5));
